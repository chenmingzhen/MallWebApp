<template>
  <swiper :options="swiperOption" ref='swiper'>
    ...
    <div class="mine-scroll-pull-down" v-if="pullDown">
      <me-loading ref="pullDownLoading" :text="pullDownText" inline></me-loading>
    </div>
    <swiper-slide>
      <slot></slot>
    </swiper-slide>
  ...
  export default {
    ...
    methods: {
      update() {
        ...
        this.$refs.swiper && this.$refs.swiper.$swiper.updateSlides();
      },
      init() {
        this.pulling = false;
      ...
      touchEnd() {
        ...
        if (swiper.translate > PULL_DOWN_HEIGHT) {
          ...
          if (isPullUp) {
            ...
            this.$emit('pull-up', this.pullUpEnd);// 发送事件
          }
        }
      },
      pullDownEnd() {
